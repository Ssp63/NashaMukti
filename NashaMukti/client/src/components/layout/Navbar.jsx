...
const Navbar = () => {
  ...
  const pages = [
    { title: translations.nav.home, path: '/' },
    { title: translations.nav.about, path: '/about' },
    { title: translations.nav.events, path: '/events' },
  ];

  const authPages = [
    { title: translations.nav.dashboard, path: '/dashboard' },
    { title: translations.nav.createEvent, path: '/create-event' },
  ];

  const settings = [
    { title: translations.nav.profile, path: '/dashboard' },
    { title: translations.nav.settings, path: '/settings' },
    { title: translations.nav.logout, onClick: handleLogout },
  ];

  if (user?.role === 'admin') {
    authPages.push({ title: translations.nav.admin, path: '/admin' });
  }
        ...
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              {/* Notifications */}
              {isAuthenticated && (
                <Tooltip title={translations.nav.notifications}>
              ...
              {/* Language Toggle */}
              <Tooltip title={translations.nav.changeLanguage}>
                <IconButton 
              ...
              {isAuthenticated ? (
                <>
                  <Tooltip title={translations.nav.settings}>
